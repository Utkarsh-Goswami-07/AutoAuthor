...
const Footer = () => {
    return (
        <footer className="relative bg-gradient-to-br from-gray-950 via-gray-950 to-violet-950 text-white overflow-hidden">
            ...
            <div className="absolute insert-0 opacity-5">
                <div className="absolute top-0 right-0 w-96 h-96 bg-violet-500 rounded-full blur-3xl"></div>
            </div>

            <div className="relative max-w-7xl mx-auto px-6 lg:px-8">   {/* A */}
                <div className="py-16 grid grid-cols-1 md:grid-cols-12 gap-12">  {/* B */}
                    {/* Brand Section */}
                    <div className="md:col-span-5 space-y-6">  {/* C */}
                    ...
                    <div className="md:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                <li><a href="#privacy" className="text-gray-400 hover:text-violet-400 transition-colors duration-200 text-sm">Privacy</a></li>
                                <li><a href="#terms" className="text-gray-400 hover:text-violet-400 transition-colors duration-200 text-sm">Terms</a></li>
                            </ul>
                        </div>
                    </div>
                </div> {/* CLOSES B */}
                ...
                <div className="border-t border-white/10 py-8">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        ...
                        <p className="text-gray-500 text-sm">
                            Made with <span className="text-violet-400">♥</span> for readers
                        </p>
                    </div>
                </div>
            </div> {/* CLOSES A */}
